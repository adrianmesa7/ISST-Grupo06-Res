...
public class FormAdminServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	  ...
	  if (resumen != null) {
	       resumen.setTitle(request.getParameter("title"));
	       resumen.setName(request.getParameter("name"));
	       resumen.setPuntuacion(Double.parseDouble(request.getParameter("puntuacion")));
